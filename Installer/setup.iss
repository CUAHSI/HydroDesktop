...
Source: "..\Binaries\Microsoft.VisualBasic.PowerPacks.Vs.dll"; DestDir: "{app}\Application Extensions"; Flags: ignoreversion;
...
;SampleProjects
Source: "..\DotSpatial.SampleProjects.NorthAmerica\*"; DestDir: "{app}\hydrodesktop_sample_projects\DotSpatial.SampleProjects.NorthAmerica"; Flags: recursesubdirs;
