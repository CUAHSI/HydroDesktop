...
namespace HydroDesktop.WebServices.WaterOneFlow
{
    public abstract class WaterOneFlowParser : IWaterOneFlowParser
    {
        ...
        protected virtual Source ReadSource(XmlReader r)
        {
            ...
            while (r.Read())
            {
                ...
                else if (r.NodeType == XmlNodeType.EndElement && nodeName == "source")
                {
                    break;
                }
            }
