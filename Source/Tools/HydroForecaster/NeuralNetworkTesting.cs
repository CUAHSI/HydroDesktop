...
namespace HydroForecaster
{
    class NeuralNetworkTesting
    {
     ...
     public   int numLayers;
      ...
      public string TestingStartDate;
      ...
      private string variableId;
        ...
        public NeuralNetworkTesting(int _numLayers, int[] _layersNeurons, int[] _layersTypes, int _dimInput)
        {
        ...
        public void loadNetwork(string fileName)
        {
            ...
            for (int l = 0; l < this.numLayers; l++)
            {
                ...
                while (neuronCount < this.layersNeurons[l])
                {
                    ...
                    {
                        _weightSet = new float[this.layersNeurons[l - 1] + 1];
                        //_weightSet = new float[this.layersNeurons[l]];  //Teva Modification
                     }
        ...
        public void runTest(string testFile,string outPutFile)
        {
            ...
            siteId = fileIn.ReadLine();

            variableId = fileIn.ReadLine();

           TestingStartDate = fileIn.ReadLine();
           ...
           // line = line.IndexOf(' ').ToString();
            ...
            for (int x = 0; x < numInput; x++)
            {
                ...
                DateTime dt = Convert.ToDateTime(TestingStartDate);
                 
                for (int i = 0; i < this.layersNeurons[this.numLayers - 1]; i++)
                {
                   
                  DateTime Testupdate = dt.AddDays(Counter);
                  fileOut.Write(Testupdate + "," + output[i] + " ");
                  Counter += 1;
                }
                ...
                fileOut.WriteLine(siteId + "," + variableId);
