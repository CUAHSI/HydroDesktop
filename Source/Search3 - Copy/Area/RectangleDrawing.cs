...
namespace Search3.Area
{
    ...
    public class RectangleDrawing
    {
        ...
        private void DisableLayerSelection()
        {
            ...
            {
                if (lay.LegendText != ShaleDataNetwork.Properties.Resources.RectangleLayerName)
                {
        ...
        public void RestoreSearchRectangle(double minLon, double minLat, double maxLon, double maxLat)
        {
            ...
            if (_rectangleLayer != null)
            {
                ...
                ProjectionInfo wgs84 = ProjectionInfo.FromEsriString(ShaleDataNetwork.Properties.Resources.wgs_84_esri_string);
        ...
        private void AddRectangleLayer()
        {
            ...
            if (_rectangleLayer == null)
            {
                _rectangleLayer = _mainMap.GetAllLayers().OfType<MapPolygonLayer>().FirstOrDefault(lay => lay.LegendText == ShaleDataNetwork.Properties.Resources.RectangleLayerName);
            }
            if (_rectangleLayer == null)
            {
                ...
                _rectangleLayer = new MapPolygonLayer(rectangleFs) { LegendText = ShaleDataNetwork.Properties.Resources.RectangleLayerName };
        ...
        {
            return _mainMap.GetAllLayers().Cast<IMapLayer>().Any(lay => lay.LegendText == ShaleDataNetwork.Properties.Resources.RectangleLayerName);
        }
