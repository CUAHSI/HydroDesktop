Namespace Controls
    ...
    Partial Class ColorSettingsDialog
        ...
        Private Sub InitializeComponent()
            ...
            Me.ColorPalettePoint = New GraphView.ColorPalette()
            Me.ColorPaletteLine = New GraphView.ColorPalette()
            Me.ColorPaletteCustom = New GraphView.ColorPalette()
            Me.ColorPalette10 = New GraphView.ColorPalette()
            Me.ColorPalette9 = New GraphView.ColorPalette()
            Me.ColorPalette8 = New GraphView.ColorPalette()
            Me.ColorPalette7 = New GraphView.ColorPalette()
            Me.ColorPalette6 = New GraphView.ColorPalette()
            Me.ColorPalette5 = New GraphView.ColorPalette()
            Me.ColorPalette4 = New GraphView.ColorPalette()
            Me.ColorPalette3 = New GraphView.ColorPalette()
            Me.ColorPalette2 = New GraphView.ColorPalette()
            Me.ColorPalette1 = New GraphView.ColorPalette()
            Me.SuspendLayout()
            '
            'lblCurrentLineColor
            '
        ...
        Friend WithEvents ColorPalette1 As GraphView.ColorPalette
        Friend WithEvents ColorPalette2 As GraphView.ColorPalette
        Friend WithEvents ColorPalette3 As GraphView.ColorPalette
        Friend WithEvents ColorPalette4 As GraphView.ColorPalette
        Friend WithEvents ColorPalette5 As GraphView.ColorPalette
        Friend WithEvents ColorPalette6 As GraphView.ColorPalette
        Friend WithEvents ColorPalette7 As GraphView.ColorPalette
        Friend WithEvents ColorPalette8 As GraphView.ColorPalette
        Friend WithEvents ColorPalette9 As GraphView.ColorPalette
        Friend WithEvents ColorPalette10 As GraphView.ColorPalette
        Friend WithEvents ColorPaletteCustom As GraphView.ColorPalette
        Friend WithEvents ColorPaletteLine As GraphView.ColorPalette
        Friend WithEvents ColorPalettePoint As GraphView.ColorPalette
