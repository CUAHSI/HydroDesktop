Namespace Controls
    ...
    Partial Class MainControl
        ...
        Private Sub InitializeComponent()
            ...
            Me.dataSummary = New HydroDesktop.Plugins.GraphView.Controls.DataSummary()
            Me.tpBoxWhisker = New System.Windows.Forms.TabPage()
            Me.boxWhisker = New HydroDesktop.Plugins.GraphView.Controls.BoxWhiskerPlot()
            Me.tpHistogram = New System.Windows.Forms.TabPage()
            Me.histogramPlot = New HydroDesktop.Plugins.GraphView.Controls.HistogramPlot()
            Me.tpProbability = New System.Windows.Forms.TabPage()
            Me.probabilityPlot = New HydroDesktop.Plugins.GraphView.Controls.ProbabilityPlot()
            Me.tpTimeSeries = New System.Windows.Forms.TabPage()
            Me.timeSeriesPlot = New HydroDesktop.Plugins.GraphView.Controls.TimeSeriesPlot()
