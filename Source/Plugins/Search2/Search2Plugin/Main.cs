    ...
    public class Main : Extension, IMapPlugin
    {
        ...
        private void AddRibbonItems()
        {
            if (_mapArgs.AppManager.HeaderControl != null)
            {
                ...
                //todo: add drop down button.
                const string KHydroSearch = "kHome";
                header.Add(new SimpleActionItem(KHydroSearch, "HIS Central", rbtnHISCentral_Click) { GroupCaption = "Search", SmallImage = Resources.OpenSearch });
                header.Add(new SimpleActionItem(KHydroSearch, "Metadata Cache", rbtnMetadataCache_Click) { GroupCaption = "Search", SmallImage = Resources.OpenSearch_1 });
                header.Add(new SimpleActionItem(KHydroSearch, "Advanced Settings", _rbtnAdvancedSettings_Click) { GroupCaption = "Search" });
            }
