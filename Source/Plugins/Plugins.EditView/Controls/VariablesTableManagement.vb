...
Namespace HydroDesktop.Plugins.Controls
    ...
    Public Class VariablesTableManagement

        Private _VariableID As Int64?
        ...
        Public ReadOnly Property VariableID() As Int64?
            Get
                Return _VariableID
            End Get
        End Property

        Public Sub initialize(ByVal variableID As Int64?)
            ...
            If Not _VariableID.HasValue Then
                btnSubmit.Text = "Add"
                rbtnRegularYes.Checked = True
            Else
                Dim variable = _variablesRepo.GetByKey(_VariableID.Value)
