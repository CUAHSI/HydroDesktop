...
#Region "Event"
    ...
    Private Sub EditingReminder(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.Validating
    ...
    Public Sub btnFlag_Click()
        If Editing Then
            If dgvDataValues.SelectedRows.Count >= 1 Then
                ...
                'QualifiersTableManagement.Show()
                QualifiersTableManagement.Visible = False
                QualifiersTableManagement._cEditView = Me
                Dim answer As DialogResult = QualifiersTableManagement.ShowDialog()
