...
#Region "Variables"
        ...
        Private Const _pluginName As String = "Graph2"
        ...
        Private demoTextBox As TextEntryActionItem
        Private rbDisableText As SimpleActionItem
...
#Region "IExtension Members"
        ...
        Private Sub InitializeRibbonButtons()
            ...
            'Zoom In
            rbZoomIn = New SimpleActionItem("Untoggle the Test Button", AddressOf untoggle_Click)
            ...
            ' Zoom Out
            rbZoomOut = New SimpleActionItem("Test Button", AddressOf rbTestButton_Click)
            rbZoomOut.RootKey = kGraph
            rbZoomOut.ToggleGroupKey = "kZoomOutToggle"
            rbZoomOut.GroupCaption = rpChart
            App.HeaderControl.Add(rbZoomOut)

            rbDisableText = New SimpleActionItem("Disable Text Box", AddressOf rbDisableText_Click)
            rbDisableText.RootKey = kGraph
            rbDisableText.GroupCaption = rpChart
            App.HeaderControl.Add(rbDisableText)

            'test
            demoTextBox = New TextEntryActionItem()
            demoTextBox.RootKey = kGraph
            demoTextBox.GroupCaption = rpChart
            App.HeaderControl.Add(demoTextBox)
...
#Region "Event Handlers"
        ...
        Sub rbTestButton_Click()

        End Sub

        Sub rbDisableText_Click()
            If rbDisableText.Caption = "Disable Text Box" Then
                demoTextBox.Enabled = False
                rbDisableText.Caption = "Enable Text Box"
            Else
                rbDisableText.Caption = "Disable Text Box"
